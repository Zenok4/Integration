      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
        {((role === "admin" ||
          ...
          role === "payroll_manager") && (
            <Link
              href="/nhan-vien"
              className="card p-5 border-l-4 border-blue-500 hover:border-blue-600"
            >
        ...
        {((role === "admin" ||
          ...
          role === "payroll_manager") && (
            <Link
              href="/luong"
              className="card p-5 border-l-4 border-green-500 hover:border-green-600"
            >
        ...
        <Link
          href="/bang-luong"
          className="card p-5 border-l-4 border-sky-500 hover:border-sky-600"
        >
          <h2 className="text-xl font-semibold mb-2 text-blue-600">
            Bảng lương
          </h2>
          <p className="text-slate-600">Xem bảng lương của nhân viên</p>
        </Link>
        ...
        {((role === "admin" ||
          ...
          role === "payroll_manager") && (
            <Link
              href="/cham-cong"
              className="card p-5 border-l-4 border-amber-500 hover:border-amber-600"
            >
        ...
        {((role === "admin" ||
          ...
          role === "payroll_manager") && (
            <Link
              href="/bao-cao"
              className="card p-5 border-l-4 border-purple-500 hover:border-purple-600"
            >
        ...
        <Link
          href="/thong-bao"
          className="card p-5 border-l-4 border-red-500 hover:border-red-600"
        >
        ...
        <Link
          href="/cai-dat"
          className="card p-5 border-l-4 border-slate-500 hover:border-slate-600"
        >
